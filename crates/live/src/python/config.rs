...
impl LiveExecEngineConfig {
    ...
    fn py_new(
        ...
        reconciliation_strategy_ids: Option<Vec<String>>,
    ...
    #[getter]
    fn reconciliation_strategy_ids(&self) -> Option<Vec<String>> {
        self.reconciliation_strategy_ids.clone()
    }
}
